...
#endif
#if defined(BSP_USING_EMAC1)
LWIP_MEMPOOL_DECLARE(emac1_rx, RECEIVE_DESC_SIZE, sizeof(struct nu_emac_lwip_pbuf), "GMAC1 RX PBUF pool");
#endif
...
#if 0
/*
    Remeber src += lwipiperf_SRCS in componentset\lwip-*\SConscript
*/
               ...
               u32_t bytes_transferred, u32_t ms_duration, u32_t bandwidth_kbitpsec)
{
    ...
    LOG_I("IPERF report: type=%d, remote: %s:%d, total bytes: %"U32_F", duration in ms: %"U32_F", kbits/s: %"U32_F"",
