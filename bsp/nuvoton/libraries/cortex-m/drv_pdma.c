...
static struct nu_pdma nu_pdma_arr[PDMA_CNT] =
{
#if defined(PDMA0)
    DEFINE_NU_PDMA(0),
#endif
...
static rt_err_t nu_pdma_timeout_set(int i32ModChnID, int i32Timeout_us)
{
    ...
    if (i32Timeout_us)
    {
        ...
        if (i32Timeout_us && u32ModChannId <= 1)   // M480 limit
        {
            pdma->TOUTPSC |= (u32Divider << (PDMA_TOUTPSC_TOUTPSC1_Pos * u32ModChannId));
